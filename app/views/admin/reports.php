<?php
/**
 * IRONCORE Admin Reports Placeholder View
 */
...
<head>
  ...
  <title>Reports & Analytics | IRONCORE</title>
  ...
  <div class="dashboard-shell">
    ...
    <aside class="sidebar">
      ...
      <ul class="sidebar-nav">
        ...
        <li><a href="/admin/reports.php" class="nav-item-link active"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor"><line x1="18" y1="20" x2="18" y2="10"/><line x1="12" y1="20" x2="12" y2="4"/><line x1="6" y1="20" x2="6" y2="14"/></svg><span>Reports</span></a></li>
      </ul>
    ...
    <div class="main-wrapper">
      <header class="dashboard-header">
        <div style="display: flex; align-items: center; gap: 1rem;">
          ...
          <div class="header-title-group">
            ...
            <p>Operational analytics, membership retention rates, & financial forecasts.</p>
          </div>
        </div>
      </header>
      ...
      <main class="dashboard-body">
        <div class="panel-card" style="padding: 3rem; text-align: center; max-width: 720px; margin: 2rem auto;">
          ...
          <h2 style="font-size: 1.8rem; margin-bottom: 0.75rem;">REPORTS & ANALYTICS</h2>
          <p style="color: var(--color-text-muted); margin-bottom: 2rem; line-height: 1.6;">This section will generate exportable financial summaries, member churn insights, and trainer performance metrics. Database integration is planned for the next development phase.</p>
