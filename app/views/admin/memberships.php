<?php
/**
 * IRONCORE Admin Membership Management Placeholder View
 */
...
<head>
  ...
  <title>Membership Management | IRONCORE</title>
  ...
  <div class="dashboard-shell">
    ...
    <aside class="sidebar">
      ...
      <ul class="sidebar-nav">
        ...
        <li><a href="/admin/memberships.php" class="nav-item-link active"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor"><rect x="1" y="4" width="22" height="16" rx="2"/><line x1="1" y1="10" x2="23" y2="10"/></svg><span>Memberships</span></a></li>
    ...
    <div class="main-wrapper">
      <header class="dashboard-header">
        <div style="display: flex; align-items: center; gap: 1rem;">
          ...
          <div class="header-title-group">
            ...
            <p>Configure subscription plans, pricing tiers, & duration terms.</p>
          </div>
        </div>
      </header>
      ...
      <main class="dashboard-body">
        <div class="panel-card" style="padding: 3rem; text-align: center; max-width: 720px; margin: 2rem auto;">
          ...
          <h2 style="font-size: 1.8rem; margin-bottom: 0.75rem;">MEMBERSHIP MANAGEMENT</h2>
          <p style="color: var(--color-text-muted); margin-bottom: 2rem; line-height: 1.6;">This section will allow gym administrators to configure Starter, Pro, and Elite pricing tiers, feature perks, and billing cycles. Database integration is planned for the next development phase.</p>
