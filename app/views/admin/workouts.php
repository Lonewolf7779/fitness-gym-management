<?php
/**
 * IRONCORE Admin Workouts Management Placeholder View
 */
...
<head>
  ...
  <title>Workout Programs | IRONCORE</title>
  ...
  <div class="dashboard-shell">
    ...
    <aside class="sidebar">
      ...
      <ul class="sidebar-nav">
        ...
        <li><a href="/admin/workouts.php" class="nav-item-link active"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor"><path d="M6.5 6.5h11M6.5 17.5h11M4 10h16M4 14h16M2 6v12M22 6v12"/></svg><span>Workouts</span></a></li>
    ...
    <div class="main-wrapper">
      <header class="dashboard-header">
        <div style="display: flex; align-items: center; gap: 1rem;">
          ...
          <div class="header-title-group">
            ...
            <p>Master exercise library, routine templates, & workout plan catalog.</p>
          </div>
        </div>
      </header>
      ...
      <main class="dashboard-body">
        <div class="panel-card" style="padding: 3rem; text-align: center; max-width: 720px; margin: 2rem auto;">
          ...
          <h2 style="font-size: 1.8rem; margin-bottom: 0.75rem;">WORKOUT MANAGEMENT</h2>
          <p style="color: var(--color-text-muted); margin-bottom: 2rem; line-height: 1.6;">This section will house the global exercise database, pre-built hypertrophy/cardio routine templates, and trainer assignment tools. Database integration is planned for the next development phase.</p>
