...
<body style="background-color: var(--color-bg);">
  <div class="dashboard-shell">
    <aside class="sidebar">
      ...
      <div style="font-size: 0.75rem; text-transform: uppercase; color: var(--color-accent); font-weight: 800; margin-bottom: 1rem;">TRAINER PORTAL</div>

      <nav style="display: flex; flex-direction: column; gap: 0.75rem;">
        <a href="/trainer/index.php" class="btn btn-primary" style="justify-content: flex-start;">My Clients</a>
      ...
      <div style="margin-top: auto; padding-top: 2rem; border-top: 1px solid var(--color-border);">
        <div style="font-size: 0.9rem; font-weight: 700;"><?= e($_SESSION['full_name'] ?? 'Trainer') ?></div>
    ...
    <main class="main-content">
      <h1 style="font-size: 2.2rem; margin-bottom: 0.5rem;">TRAINER DASHBOARD</h1>
      <p style="color: var(--color-text-muted); margin-bottom: 2.5rem;">Assigned athletes and custom workout program management.</p>
      ...
      <div class="metrics-row" style="margin-bottom: 2.5rem;">
        ...
        <div class="metric-card">
          <div class="metric-label">Active Workout Plans</div>
